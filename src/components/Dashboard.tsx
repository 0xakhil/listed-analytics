...
export function Dashboard() {
  ...
  return <main className="mx-auto max-w-6xl px-5 py-8 sm:px-8 sm:py-10">
    ...
    <section className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5"><Metric label="Volume" value={usd(activity.volume, 2)} note="Confirmed swap notional" /><Metric label="Fees" value={usd(activity.fees, 2)} note="Applied fees only" /><Metric label="Wallets" value={whole(activity.users)} note="Unique traders" /><Metric label="3+ trade wallets" value={whole(activity.repeatUsers)} note="Active repeat traders" /><Metric label="Trades" value={whole(activity.swaps)} note="Confirmed swaps" /></section>
